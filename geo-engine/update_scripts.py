"""
Overwrite scripts with Bengaluru-specific versions
"""

import os

def update_scripts():
    """Update simulate_telemetry.py for Bengaluru"""
    
    with open("scripts/simulate_telemetry.py", "w", encoding="utf-8") as f:
        f.write('''"""
...
''')
    ...
    print("   - simulate_telemetry.py (Bengaluru-specific)")
