"""
Script to generate all GeoEngine backend files for Bengaluru
This creates/overwrites the backend Python modules with Bengaluru-specific implementations
"""

import os

# Dictionary of all backend files to create
backend_files = {
    "routing.py": '''"""
...
def compute_route(start_lat: float, start_lon: float, 
    ...
    distance_km = total_dist_meters / 1000
